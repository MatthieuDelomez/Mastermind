...
public class ModeDefenseur extends JPanel implements Observer{
	 ...
	 */
	private ImageIcon imgEmplacementVide = new ImageIcon("ressources/EmplacementVide.png"),
			
			imgEmplacementVideSolution = new ImageIcon("ressources/EmplacementVideSolution.png"),
			
			imgCouleurVerte = new ImageIcon("ressources/CouleurVerte.png"),
			
			imgCouleurJaune = new ImageIcon("ressources/CouleurJaune.png"),
			
			imgCouleurBleu = new ImageIcon("ressources/CouleurBleu.png"),

			imgCouleurBleuFonce = new ImageIcon("ressources/CouleurBleuFonce.png"),
			
			imgCouleurGris = new ImageIcon("ressources/CouleurGris.png"),
			
			imgCouleurMarron = new ImageIcon("ressources/CouleurMarron.png"),
			
			imgCouleurNoir = new ImageIcon("ressources/CouleurNoir.png"),
			
			imgCouleurOrange = new ImageIcon("ressources/CouleurOrange.png"),

			imgCouleurRouge = new ImageIcon("ressources/CouleurRouge.png"),
			
			imgCouleurViolet = new ImageIcon("ressources/CouleurViolet.png"),
			
			imgPionRougeSoluce = new ImageIcon("ressources/PionRougeSolution.png"),
			
			imgPionBlancSoluce = new ImageIcon("ressources/PionBlancSolution.png"),
			
			imgEmplacementVideSoluceCombiSecreteMan = new ImageIcon("ressources/EmplacementVideSolutionCombiSecreteCpu.png");
	 ...
	 */
	private JLabel premiereInstruction = new JLabel("Veuillez choisir une combinaison secrte."),
	...
	private JButton effacerCombiSecrete = new JButton("Effacer"),
			...
			validerCombiSecrete = new JButton("validier"),
	...
	public ModeDefenseur(int nbCase, int nbEssai, int nbCouleur, boolean modeDeveloppeurActive, DonneeMaster modelMaster ) {
		...
		boutonCouleurBleu.setPreferredSize(new Dimension (100,40));
		boutonCouleurBleuFonce.setPreferredSize(new Dimension (100,40));
		boutonCouleurRouge.setPreferredSize(new Dimension (100,40));
		boutonCouleurViolet.setPreferredSize(new Dimension (100,40));
		boutonCouleurVerte.setPreferredSize(new Dimension (100,40));
		boutonCouleurGris.setPreferredSize(new Dimension (100,40));
		boutonCouleurMarron.setPreferredSize(new Dimension (100,40));
		boutonCouleurNoir.setPreferredSize(new Dimension (100,40));
		boutonCouleurOrange.setPreferredSize(new Dimension (100,40));
		boutonCouleurJaune.setPreferredSize(new Dimension (100,40));
		...
		containerReponseMan.setPreferredSize(new Dimension(100,40));
	...
	private void initialisationGrilleJeu() {
		...
		containerGrilleJeu.setPreferredSize(new Dimension(30*(nbCase +2),
				...
				29*this.nbEssai));
		tab2DimenGrilleJeu = new JLabel[this.nbEssai][this.nbCase];
		...
		for (int i = 0; i< this.nbEssai; i++) {
			for (int j = 0; j < this.nbCase; j++) {
				if(j==0) {
					...
					tab2DimenGrilleJeu[i][j].setForeground(Color.BLACK);
					tab2DimenGrilleJeu[i][j].setBorder(BorderFactory.createLineBorder(Color.BLACK));
		...
		for (int i = 0; i <this.nbEssai; i++) {
			...
			containerSoluce[i].setBorder(BorderFactory.createLineBorder(Color.BLACK));
