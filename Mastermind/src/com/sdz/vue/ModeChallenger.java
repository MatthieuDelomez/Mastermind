...
public class ModeChallenger extends JPanel implements Observer {
	...
	private ImageIcon imgEmplacementVide = new ImageIcon("ressources/EmplacementVide.png"),
			          ...
			          imgCouleurBleu = new ImageIcon("resources/CouleurBleu.png"),
			          
			          imgCouleurOrange = new ImageIcon("resources/CouleurOrange.png"),
			          
			          imgCouleurRouge = new ImageIcon("resources/CouleurRouge.png"),
			          
					  imgCouleurJaune = new ImageIcon("resources/CouleurJaune.png"),
					  
					  imgCouleurViolet = new ImageIcon("resources/CouleurViolet.png"),
					  
					  imgPionRougeSolution = new ImageIcon("resources/PionRougeSolution.png"),
					  
					  imgPionBlancSolution = new ImageIcon("resources/PionBlancSolution.png"),
					  
					  imgEmplacementVideSolutionCombiSecreteCpu = new ImageIcon("resources/EmplacementVideSolutionCombiSecreteCpu.png"),
						
					  imgCouleurGris = new ImageIcon("resources/CouleurGris.png"),
						
					  imgCouleurBleuFonce = new ImageIcon("resources/CouleurBleuFonce.png"),
						
					  imgCouleurNoir = new ImageIcon("resources/CouleurNoir.png"),
						
					  imgCouleurMarron = new ImageIcon("resources/CouleurMarron.png");
		...
		// Définition des listeners
				...
				bCouleurRouge.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						updateGrilleJeu(ligne, colonne,imgCouleurRouge,"3");
						colonne++;
					}	
				});
     ...
     private void initialisationGrilleJeu() {
 		...
 		LOGGER.trace("Initialisation de la Grille de jeu");
   		...
   		for (int i = 0; i < this.nbEssai; i++) {
   			...
   			for (int j = 0; j <= this.nbCase; j++) {
   				...
   				if(j == 0) {
   					...
   					tabJLabelGrilleJeu[i][j].setForeground(Color.BLACK);
   					tabJLabelGrilleJeu[i][j].setBorder(BorderFactory.createLineBorder(Color.BLACK));
   		...
   		for (int i = 0; i< this.nbEssai; i++) {
   			...
   			containerSolution[i].setBorder(BorderFactory.createLineBorder(Color.BLACK));
 	...
 	private void affichageSolution() {
 		...
 		for (int i=0;i<nbCase;i++) {
 			...
 			case '2':
 				...
 				break;
 			case '3':
 				tabJLabelSolutionCombiSecreteCpu[i]=new JLabel(imgCouleurRouge);
 				break;
 			case '4':
